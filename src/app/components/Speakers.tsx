...
const speakers = [
  ...
  { image: '', company: '株式会社Still Day One', name: '小島 英揮さん' },
  { image: '', company: '株式会社ヘプタゴン', name: '三浦 一樹さん' },
  { image: '', company: '株式会社DIGITALJET', name: '古里 武士さん' },
  { image: '', company: '株式会社Fusic', name: '清家 史郎さん' },
